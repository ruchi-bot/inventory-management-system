...
const Transactions = () => {
  ...
  const fetchTransactions = async (filterParams = filters) => {
    setLoading(true);
    try {
      const response = await adminAPI.getTransactions(filterParams);
  ...
  const handleExportPDF = async () => {
    try {
      const response = await adminAPI.exportTransactionsPDF(filters);
  ...
  const handleExportCSV = async () => {
    try {
      const response = await adminAPI.exportTransactionsCSV(filters);
